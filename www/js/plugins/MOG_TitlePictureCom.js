...
// * updatePlacement
//==============================
var _alias_mog_title_picture_commands_updatePlacement =
  Scene_Title.prototype.updatePlacement;
...
Scene_Title.prototype.updateCursor = function () {
  ...
  var nx =
    ...
    Moghunter.title_cursorX +
    this._cursorSlide[0];
  var ny =
    this.comSprite().y + this._cursor.height / 2 + Moghunter.title_cursorY;
...
Scene_Title.prototype.on_picture_com = function (index) {
  ...
  if (
    TouchInput.x >
    this._com_pictures_data[index][0] + this._com_pictures_data[index][1]
  ) {
    return false;
  }
  ...
  if (
    TouchInput.y >
    this._com_pictures_data[index][2] + this._com_pictures_data[index][3]
  ) {
    return false;
  }
  return true;
