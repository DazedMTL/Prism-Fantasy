...
// KeyboardConfig.js
// Version: 1.00  (Yanflyさん記述)
// (最終更新日：2016/05/10。merusaiaがプラグイン競合対策スクリプトに変更。デフォルトのキャプションを変更。コメントを追加。)
//=============================================================================
 ...
 */
//* // merusaiaがコメント：なぜかここに「*」だけが一行あってツクールのデバッガーでSyntaxErrorが出る…。他のプラグインにもたくさんあるけど…ミス？　それとも何らかの意図がある？
/*:ja
 ...
 * @default 左手を方向キーに割り当てる、WASDレイアウトに変更します
 *
 * @param Finish Config
 ...
 * @param Finish Help
 * @desc 完了時のヘルプを設定できます
 * @default 設定を保存します。次回起動時もこの設定が反映されます
 *
 * @param Assigned Color
 ...
 *
 * @help
 * ※ツクール公式のゲームパッドプラグインを同内容です。
 * 他のプラグインと競合しないような対策と、デフォルトのキャプションだけを、merusaiaが変更しています。
 * 必要に応じて、プラグイン編集画面でキャプションを変更してください。
 *
...
// merusaiaがコメント：
//   Yanflyさんのcallを使う書き方でも、このプラグインの下にWindow_Options.prototype.addGeneralOptions = function()
//   を上書きするプラグインがあっても、競合しないようになっているはずなんだけど、なぜかうまく動かなかった。。
//   トリアコンタンさんのソースを参考に、競合しないように変更。
//=============================================================================
// Window_Options
//=============================================================================
//
...
//=============================================================================
//  オプション項目に、addGameConfigCommand()メソッド内に書かれてある項目（ゲームパッドコンフィグ）を追加します。
...
// };
//=============================================================================
var _KeyboardConfig_Window_Options_addGeneralOptions =
  Window_Options.prototype.addGeneralOptions;
Window_Options.prototype.addGeneralOptions = function () {
  _KeyboardConfig_Window_Options_addGeneralOptions.apply(this, arguments); // 上書き後メソッドの最初に、上書き前メソッドを呼び出す。
  this.addKeyConfigCommand(); // この行から、上書き後のメソッドの処理を実行。
...
Yanfly.KeyConfig.Window_Options_drawItem = Window_Options.prototype.drawItem;
...
Yanfly.KeyConfig.Window_Options_processOk = Window_Options.prototype.processOk;
...
Window_KeyConfig._refId = {
  ...
  ",": 188,
  ".": 190,
  "/": 191, //'Shift': 16, //merusaiaコメント：なぜかShiftが２つ定義されてる…ミス？
  "↑": 38,
  "#pD1": 97,
  "#pD2": 98,
  "#pD3": 99,
...
Window_KeyConfig.prototype.actionKey = function (action) {
  switch (action) {
    case "ok":
      ...
      break; // merusaiaがコメント。returnの時は、breakは要らないみたいだよ。VSCodeではWarningが出ます。
    case "escape":
