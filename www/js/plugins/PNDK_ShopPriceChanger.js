...
(function () {
  ...
  Window_ShopBuy.prototype.price = function (item) {
    ...
    //
    return Math.floor(
      this._price[this._data.indexOf(item)] *
        (Number(Window_Base.prototype.convertEscapeCharacters(buyingPrice)) /
          100)
    );
  };
  ...
  Scene_Shop.prototype.sellingPrice = function () {
    ...
    return Math.floor(
      this._item.price *
        (Number(Window_Base.prototype.convertEscapeCharacters(sellingPrice)) /
          100)
    );
  };
})();
