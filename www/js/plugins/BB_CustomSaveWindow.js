...
(function () {
  ...
  Window_SavefileList.prototype.drawItem = function (index) {
    ...
    if (BBSWMaxItem >= 1) {
      this.contents.fillRect(
        rect.x + rect.width - 278,
        rect.y + 70,
        BBSWTF1,
        26,
        this.textColor(BBSWOutFC)
      ); //タイトル背景
      this.contents.fillRect(
        rect.x + rect.width - 278,
        rect.y + 68,
  ...
  Window_SavefileList.prototype.drawContents = function (info, rect, valid) {
    ...
    if (rect.width >= 420) {
      ...
      if (BBSWItem0 == 1) {
        ...
        this.drawText(
          info.gold + TextManager.currencyUnit,
          rect.x + 142,
          rect.y,
          BBSWItem0L
        );
    ...
    if (y2 >= lineHeight) {
      ...
      if (BBSWItem1 == 1) {
        this.drawText(
          info.title,
          rect.x + rect.width - 274 + BBSWTF1,
          y2 - 2,
          266 - BBSWTF1,
          "right"
        ); //rect.x - 7, y2 - 2, rect.width
      } else if (BBSWItem1 == 2) {
        this.drawText(
          info.playtime,
          rect.x + rect.width - 274 + BBSWTF1,
      ...
      if (BBSWItem2 == 1) {
        this.drawText(
          info.title,
          rect.x + rect.width - 274 + BBSWTF2,
          y2 - 34,
          266 - BBSWTF2,
          "right"
        ); //rect.x - 7, y2 - 34, rect.width
      } else if (BBSWItem2 == 2) {
        this.drawText(
          info.playtime,
          rect.x + rect.width - 274 + BBSWTF2,
      ...
      if (BBSWItem3 == 1) {
        this.drawText(
          info.title,
          rect.x + rect.width - 554 + BBSWTF3,
          y2 - 2,
          266 - BBSWTF3,
          "right"
        ); //rect.x - 287, y2 - 2, rect.width
      } else if (BBSWItem3 == 2) {
        this.drawText(
          info.playtime,
          rect.x + rect.width - 554 + BBSWTF3,
      ...
      if (BBSWItem4 == 1) {
        this.drawText(
          info.title,
          rect.x + rect.width - 554 + BBSWTF4,
          y2 - 34,
          266 - BBSWTF4,
          "right"
        ); //rect.x - 287, y2 - 34, rect.width
      } else if (BBSWItem4 == 2) {
        this.drawText(
          info.playtime,
          rect.x + rect.width - 554 + BBSWTF4,
      ...
      if (BBSWItem5 == 1) {
        this.drawText(
          info.title,
          rect.x - L5 + rect.width,
          rect.y,
          L5,
          "right"
        ); //rect.x + 455, rect.y, 312,
      } else if (BBSWItem5 == 2) {
        this.drawText(
          info.playtime,
          rect.x - L5 + rect.width,
  ...
  Window_SavefileList.prototype.drawPartyCharacters = function (
    info,
    x,
    y,
    bottom
